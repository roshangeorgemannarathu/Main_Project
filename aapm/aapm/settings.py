"""
Django settings for aapm project.
...
SECRET_KEY = 'django-insecure-4)7cevn8+p7orw%ntc+u4fe+r-1x22#btqi&n_#hu0f&1oe6#l'
...
WSGI_APPLICATION = 'aapm.wsgi.application'
